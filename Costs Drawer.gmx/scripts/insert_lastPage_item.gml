/// insert_lastPage_item(item to insert, list position);
/* RETURNS new item id
 *
...
//if (ds_list_find_index(list,newItem) == -1) // if we're not on the list...
var pos = ds_list_find_index(list,newItem)
if (pos > -1) ds_list_delete(list,pos);
